  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#0A0A0A] relative pb-32">
      ...
      <div className="relative pt-32 px-6 md:px-10 pb-8 flex flex-col md:flex-row justify-between items-end gap-10 min-h-[380px] z-10 group">
        ...
        {(artistVideoUrl || user) && (
          <div className="relative w-full max-w-[320px] md:max-w-[480px] aspect-video rounded-2xl overflow-hidden shadow-2xl border border-white/10 mt-4 md:mt-0 lg:mr-8 flex-shrink-0 group/video bg-black/20 backdrop-blur-sm">
            {artistVideoUrl ? (
              <>
                <video 
                  src={artistVideoUrl}
                  ...
                  className="w-full h-full object-cover pointer-events-none select-none scale-[1.15] origin-center"
                />
